package example.glh.tencenthotfix.application;
...
import example.glh.tencenthotfix.service.SampleResultService;


@SuppressWarnings("unused")
@DefaultLifeCycle(application = "example.glh.tencenthotfix.TinkerApp",
